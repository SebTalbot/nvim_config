...
M.telescope = function()
	...
	map("n", "<leader>fF", "<cmd>Telescope find_files temp__scrolling_limit=10000<CR>")
...
-- LSP
M.lsp = function()
	map("n", "<leader>ll", "<cmd>lua vim.lsp.buf.declaration()<CR>")
	map("n", "<S-k>", "<cmd>lua vim.lsp.buf.hover()<CR>")
	map("n", "<leader>laf", "<cmd>lua _LspCustomFormat()<CR>")
	...
	map("n", "<leader>eP", "<cmd>lua vim.diagnostic.goto_prev({severity = vim.diagnostic.severity.ERROR})<CR>")
	map("n", "<leader>en", "<cmd>lua vim.diagnostic.goto_next()<CR>")
	map("n", "<leader>eN", "<cmd>lua vim.diagnostic.goto_next({severity = vim.diagnostic.severity.ERROR})<CR>")
