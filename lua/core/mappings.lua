...
n("<leader>ga", "", "Actions")
n("<leader>gar", "Gitsigns reset_hunk", "Hunk Reset")
n("<leader>gaR", "Gitsigns reset_buffer", "Buffer Reset")
n("<leader>gas", "Gitsigns stage_hunk", "Hunk Stage")
n("<leader>gaS", "Gitsigns stage_buffer", "Buffer Stage")
